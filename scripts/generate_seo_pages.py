...
UNIVERSITIES = {
    "shandong-university.html": "山东大学",
    "sichuan-university.html": "四川大学",
    "wuhan-university.html": "武汉大学",
    "zhongshan-university.html": "中山大学",
    "tianjin-university.html": "天津大学",
    "xian-jiaotong-university.html": "西安交通大学",
    "hunan-university.html": "湖南大学",
    "jilin-university.html": "吉林大学",
    "hust.html": "华中科技大学",
    "southeast-university.html": "东南大学",
}


def render_school_page(filename: str, school: str, links: str) -> str:
    return f"""<!doctype html>
<html lang="zh-CN">
  <head>
    <meta charset="utf-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1" />
    <title>{school}国际合作分析 | 合作国家、机构排行与学科热点</title>
    <meta name="description" content="查看{school}国际合作论文、合作国家、合作机构排行、学科热点和近年合作趋势，适合高校国际处、科研院和学科建设部门做合作决策参考。" />
  ...
  <body>
    <main>
      <a href="/">高校国际合作智析平台</a>
      <h1>{school}国际合作分析</h1>
      <p>面向{school}国际合作管理与科研决策场景，聚合公开论文数据，观察合作国家、合作机构、学科热点和近年变化趋势。</p>
      <section class="grid">
      ...
      <p><a class="button" href="/login">登录查看完整样例数据</a></p>
      <h2>更多高校国际合作分析</h2>
      <ul>{links}</ul>
    </main>
  </body>
...
def main() -> None:
    ...
    links = "".join(
        f'<li><a href="/universities/{filename}">{school}国际合作分析</a></li>'
        for filename, school in UNIVERSITIES.items()
    )
    for filename, school in UNIVERSITIES.items():
        (output_dir / filename).write_text(render_school_page(filename, school, links), encoding="utf-8")
